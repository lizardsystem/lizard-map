...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkspaceStorage.private'
        db.add_column('lizard_map_workspacestorage', 'private',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkspaceStorage.private'
        db.delete_column('lizard_map_workspacestorage', 'private')
