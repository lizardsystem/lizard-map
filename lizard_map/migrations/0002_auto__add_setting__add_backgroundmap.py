...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_map_setting', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('lizard_map', ['Setting'])

        # Adding model 'BackgroundMap'
        db.create_table('lizard_map_backgroundmap', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('index', self.gf('django.db.models.fields.IntegerField')(default=100)),
            ('default', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('layer_type', self.gf('django.db.models.fields.IntegerField')()),
            ('google_type', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('layer_url', self.gf('django.db.models.fields.CharField')(default='http://tile.openstreetmap.nl/tiles/${z}/${x}/${y}.png', max_length=200, null=True, blank=True)),
            ('layer_names', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('lizard_map', ['BackgroundMap'])


    def backwards(self, orm):
        
        # Deleting model 'Setting'
        db.delete_table('lizard_map_setting')

        # Deleting model 'BackgroundMap'
        db.delete_table('lizard_map_backgroundmap')
