...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BackgroundMap.is_single_tile'
        db.add_column('lizard_map_backgroundmap', 'is_single_tile',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BackgroundMap.is_single_tile'
        db.delete_column('lizard_map_backgroundmap', 'is_single_tile')
