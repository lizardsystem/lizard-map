...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CollageStorageItem'
        db.create_table(u'lizard_map_collagestorageitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=80, blank=True)),
            ('adapter_class', self.gf('django.db.models.fields.SlugField')(max_length=50)),
            ...
            ('collage_storage', self.gf('django.db.models.fields.related.ForeignKey')(related_name='collage_items', to=orm['lizard_map.CollageStorage'])),
            ('identifier', self.gf('jsonfield.fields.JSONField')(default={})),
        ))
        db.send_create_signal(u'lizard_map', ['CollageStorageItem'])

        # Adding model 'CollageStorage'
        db.create_table(u'lizard_map_collagestorage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('secret_slug', self.gf('django.db.models.fields.CharField')(max_length=16, null=True)),
        ...
        db.send_create_signal(u'lizard_map', ['CollageStorage'])


    def backwards(self, orm):
        # Deleting model 'CollageStorageItem'
        db.delete_table(u'lizard_map_collagestorageitem')

        # Deleting model 'CollageStorage'
        db.delete_table(u'lizard_map_collagestorage')
    ...
    models = {
        ...
        u'lizard_map.collagestorageitem': {
            ...
            'boundary_value': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'clickable': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'collage_storage': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'collage_items'", 'to': u"orm['lizard_map.CollageStorage']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('jsonfield.fields.JSONField', [], {'default': '{}'}),
            'index': ('django.db.models.fields.IntegerField', [], {'default': '100', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '80', 'blank': 'True'}),
