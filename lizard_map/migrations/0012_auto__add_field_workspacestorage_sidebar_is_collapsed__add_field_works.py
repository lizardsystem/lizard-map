...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkspaceStorage.sidebar_is_collapsed'
        db.add_column('lizard_map_workspacestorage', 'sidebar_is_collapsed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'WorkspaceStorage.rightbar_is_collapsed'
        db.add_column('lizard_map_workspacestorage', 'rightbar_is_collapsed',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkspaceStorage.sidebar_is_collapsed'
        db.delete_column('lizard_map_workspacestorage', 'sidebar_is_collapsed')

        # Deleting field 'WorkspaceStorage.rightbar_is_collapsed'
        db.delete_column('lizard_map_workspacestorage', 'rightbar_is_collapsed')
