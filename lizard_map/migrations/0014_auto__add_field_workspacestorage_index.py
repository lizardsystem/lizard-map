...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkspaceStorage.index'
        db.add_column('lizard_map_workspacestorage', 'index',
                      self.gf('django.db.models.fields.IntegerField')(default=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkspaceStorage.index'
        db.delete_column('lizard_map_workspacestorage', 'index')
