...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CollageStorage.index'
        db.delete_column(u'lizard_map_collagestorage', 'index')

        # Deleting field 'CollageStorage.private'
        db.delete_column(u'lizard_map_collagestorage', 'private')


    def backwards(self, orm):
        # Adding field 'CollageStorage.index'
        db.add_column(u'lizard_map_collagestorage', 'index',
                      self.gf('django.db.models.fields.IntegerField')(default=100),
                      keep_default=False)

        # Adding field 'CollageStorage.private'
        db.add_column(u'lizard_map_collagestorage', 'private',
    ...
    models = {
        ...
        u'lizard_map.collagestorage': {
            'Meta': {'object_name': 'CollageStorage'},
