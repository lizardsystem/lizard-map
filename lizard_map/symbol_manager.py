    ...
    def get_symbol_transformed(self, filename_nopath, **kwargs):
        ...
        * shadow_height: in pixels
        ...
        if os.path.isfile(result_filename) and force == False:
            ...
            filename_orig_abs = os.path.join(self.symbol_path_original, filename_nopath)
            ...
            pix = im.load() #create objects where you can read and write pixel values
...
if __name__=='__main__':
    #set symbols dir
    SYMBOLS_DIR = '/media/drv0/repo/Products/LizardWeb/Trunk/System/resources/symbols'
