...
function showMap() {
    var options, openstreetmapLayer, MapClickControl, map_click_control, map_hover_control;
    var javascript_click_handler_name, javascript_hover_handler_name, $lizard_map_wms;
